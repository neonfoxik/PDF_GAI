...
upload = InlineKeyboardButton(text="Обновить главное меню у пользователя", callback_data="upload_buttons")
ADMIN_BUTTONS_MAIN.add(buttons_act).add(documents_act).add(texts_act).add(upload)
