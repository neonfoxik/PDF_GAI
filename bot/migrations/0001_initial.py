# Generated by Django 4.1 on 2025-06-15 09:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_text', models.TextField(verbose_name='текст контента')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Parent_content', to='bot.content')),
            ],
            options={
                'verbose_name': 'кнопка',
